...
/*********************************************************************************************************************/
//取得28天前日期
public String getFourWeekAgo(String sDateFormat){
	/************************************
	sDateFormat:	指定的格式，例如"yyyyMMdd-HHmmss"或"yyyyMMdd"
	*************************************/
	TimeZone.setDefault(TimeZone.getTimeZone("Asia/Taipei"));	//將 Timezone 設為 GMT+8
	Calendar cal = Calendar.getInstance();//使用預設時區和語言環境獲得一個日曆。  
	cal.add(Calendar.DAY_OF_MONTH, -28);//取當前日期的前一天.  
	//cal.add(Calendar.DAY_OF_MONTH, +1);//取當前日期的後一天.  
...
/*********************************************************************************************************************/
//取得上個月份
public String getPreviousMonth(String sDateFormat){
	/************************************
	sDateFormat:	指定的格式，例如"yyyy-MM
	*************************************/
	TimeZone.setDefault(TimeZone.getTimeZone("Asia/Taipei"));	//將 Timezone 設為 GMT+8
	Calendar cal = Calendar.getInstance();//使用預設時區和語言環境獲得一個日曆。  
...
/*********************************************************************************************************************/
//檢查檔案是否存在
public java.lang.Boolean FileExist(String sFileName){
...
//呼叫 圖靈 API
public String sendToTuling(String info, String loc, String userid){
	/************************************
	txtURL：HSM Secure Server 網址
	txtBody：參數內容，JSON 格式，例如： {"action":"listKeys","clientId":"20160216","requestId":"20160216"}
	*************************************/
